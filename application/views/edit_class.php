    ...
    <div class="container-fluid mt-4">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-body">
                <h3 class="box-title m-b-0"> Update Class</h3>
                ...
                <form class="form-horizontal" action="<?= base_url(); ?>index.php/edit_class" method="post" >
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" value="<?= $class['class_name']  ?>" required type="text" placeholder="Enter Class Name" name="class_name">
